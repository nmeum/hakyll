...
compilerGetMetadata identifier = do
    ...
    compilerTellDependencies [Dependency KindMetadata $ IdentifierDependency identifier]
...
compilerGetMatches pattern = do
    ...
    compilerTellDependencies [Dependency KindContent $ PatternDependency pattern matching]
